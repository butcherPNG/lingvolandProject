...
class _SignInState extends State<SignIn> {
  ...
  login(String email, String password) async {
    if (formKey.currentState!.validate() == true){
      ...
      try{
        await Authent().loginWithEmailAndPassword(
        ...
        ScaffoldMessenger.of(context)
          ...
          content: Text('Неправильный E-mail или пароль!'),
        ));
      }
                            ...
                            children: [
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text('Забыли пароль?',
                                              style: navTxt(color: Color(0xffC3C3C3), fontSize: 14, weight: FontWeight.w600),),
                                            InkWell(
                                              onTap: (){},
                                              child: OnHoverWidget(
                                                builder: (bool isHovered) {
                                                  return Column(
                                                    children: [
                                                      Text('Восстановить', style: navTxt(color: isHovered? Color(0xFF828282) : Color(0xffC3C3C3), fontSize: 14, weight: FontWeight.w600),),
                                                      SizedBox(height: 2,),
                                                      Container(
                                                        width: 97,
                                                        height: 1,
                              ...
                              Column(
                                children: [
                                  ...
                                  }, text: 'Войти', width: 310, height: 48),
                                  SizedBox(height: 16,),
                                  InkWell(
                                    onTap: (){
                                    ...
                                    child: OnHoverWidget(
                                      builder: (bool isHovered) {
                                        return Column(
                                          children: [
                                            Text('Регистрация', style: navTxt(color: isHovered? Color(0xFF828282) : Color(0xffC3C3C3), fontSize: 14, weight: FontWeight.w600),),
                                            SizedBox(height: 2,),
                                            Container(
                                              width: 89,
                                              height: 1,
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                button(onClick: (){
                                  login(_emailController.text.trim(), _passwordController.text.trim());
                                }, text: 'Войти', width: 238, height: 45, radius: 4),
                                SizedBox(height: 12,),
                                InkWell(
                                  onTap: (){
                                    context.goNamed('signup');
